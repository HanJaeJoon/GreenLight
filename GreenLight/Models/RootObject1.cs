...
using static GreenLight.Models.PublicInfoResult;
...
namespace GreenLight.Models
{
    ...
    public class PublicInfoResult
    {
        ...
        public class ShortCodeMedia
        {
            ...
            public string media_preview { get; set; }
            public string display_url { get; set; }
            public List<DisplayResources> display_resources { get; set; }
            ...
            public EdgeMediaToCaption edge_media_to_tagged_user { get; set; }
            public EdgeMediaToComment edge_media_to_comment { get; set; }
            public EdgeMediaToCaption edge_media_to_caption { get; set; }
            public bool caption_is_edited { get; set; }
            public bool has_ranked_comments { get; set; }
            public ParentComment edge_media_to_parent_comment { get; set; }
            public object edge_media_to_hoisted_comment { get; set; }
            public ParentComment edge_media_preview_comment { get; set; }
            public bool comments_disabled { get; set; }
            public bool commenting_disabled_for_viewer { get; set; }
            public int taken_at_timestamp { get; set; }
            public EdgeMediaPreviewLike edge_media_preview_like { get; set; }
            public object edge_media_to_sponsor_user { get; set; }
            public object location { get; set; }
            ...
            public object edge_web_media_to_related_media { get; set; }
            public object encoding_status { get; set; }
            public bool is_published { get; set; }
            public string product_type { get; set; }
            public string title { get; set; }
